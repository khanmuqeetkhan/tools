...
function updateDisplay() {
    ...
    if (currentMode === 'learning') {
        ...
        document.getElementById('flashcard-example').textContent = currentCard.example;
        document.getElementById('flashcard-tenses').textContent = currentCard.tenses;
    }
